...
def forward():
    ...
    forward_point.pose.position.x = point_pos[shortest_way[i] - 1].pose.position.x + dx
    forward_point.pose.position.y = point_pos[shortest_way[i] - 1].pose.position.y + dy
