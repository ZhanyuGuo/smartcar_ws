...
class OdometryNode:
    ...
    def sub_robot_pose2_update(self, msg):
        ...
        try:
            arrayIndex = msg.name.index('racecar::base_footprint') # base_link -> base_footprint
    ...
    def timer_callback(self, event):
        ...
        cmd.child_frame_id = 'base_footprint' # This used to be odom, base_link -> base_footprint
